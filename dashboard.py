...
def show_dashboard():
    ...
    # 2. CSS OVERRIDES (Your original Pixel Perfect CSS)
    st.markdown("""
    <style>
        /* --- RESET & GLOBAL --- */
        ...
        /* Logout Button Style */
        .logout-btn {
            background: #1f2e38; color: #94a3b8; padding: 0.4rem 1rem;
            border: 1px solid #475569; border-radius: 8px; font-size: 0.8rem;
            cursor: pointer;
        }
        ...
        [data-testid="stFileUploaderDropzone"] button {
            ...
            font-weight: 700 !important; font-size: 1.1rem !important; width: auto !important; z-index: 10 !important;
        }
    ...
    with c_nav1:
        st.markdown("""<div class="logo">STOCK<span>POSTMORTEM</span>.AI</div>""", unsafe_allow_html=True)
    with c_nav2:
        if st.button("LOGOUT"):
    ...
    st.markdown("""
    <div class="grid">
        <div class="card"><h3>Pattern Recognition</h3><p>Did you buy the top? We identify if you're falling for FOMO or revenge trading instantly.</p></div>
        <div class="card"><h3>Risk Autopsy</h3><p>Calculates if your stop-loss was too tight or if your position sizing was reckless.</p></div>
        <div class="card"><h3>Recovery Plan</h3><p>Step-by-step technical adjustments to ensure the next trade is a winner, not a gamble.</p></div>
    </div>
    <div style="text-align: center; margin-top: 6rem; color: #64748b; font-size: 0.9rem;">&copy; 2026 stockpostmortem.ai | Trading involves risk.</div>
    """, unsafe_allow_html=True)
